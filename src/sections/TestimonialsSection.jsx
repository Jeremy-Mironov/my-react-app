import { testimonialsSection } from '../assets/dummy-data'
                ...
                <div className="mt-10 grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {testimonialsSection.items.map((testimonial) => (
                        <article
                            ...
                            className="rounded-lg border border-slate-700/60 bg-slate-900/80 p-6 transition duration-500 hover:-translate-y-1 hover:border-transparent hover:shadow-xl"
                        >
                            <p className="text-base text-slate-400">{testimonial.quote}</p>
                            <div className="mt-8 flex items-center gap-3">
                                <img className="size-12 rounded-full object-cover" src={testimonial.image} alt={testimonial.name} />
                                <div>
