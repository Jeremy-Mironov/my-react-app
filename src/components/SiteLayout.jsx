    ...
    return (
        <div className="relative flex min-h-screen flex-col bg-slate-950 text-slate-100">
            ...
            <header className="fixed top-0 left-0 z-50 w-full ">
                <nav className="bg-transparent backdrop-blur-md mx-auto my-2 flex w-full max-w-4xl items-center justify-between rounded-full border border-slate-700 px-4 py-2.5 text-white">
                    <a href="https://prebuiltui.com">
                        <svg className="pb-1" width="157" height="40" viewBox="0 0 157 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="m8.75 11.3 6.75 3.884 6.75-3.885M8.75 34.58v-7.755L2 22.939m27 0-6.75 3.885v7.754M2.405 15.408 15.5 22.954l13.095-7.546M15.5 38V22.939M29 28.915V16.962a2.98 2.98 0 0 0-1.5-2.585L17 8.4a3.01 3.01 0 0 0-3 0L3.5 14.377A3 3 0 0 0 2 16.962v11.953A2.98 2.98 0 0 0 3.5 31.5L14 37.477a3.01 3.01 0 0 0 3 0L27.5 31.5a3 3 0 0 0 1.5-2.585" stroke="#00A63E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>
                    <div
                        id="menu"
                    ...
                    >
                        ...
                        <NavLink to="/portfolio" className={navLinkClass} onClick={() => setIsMobileMenuOpen(false)}>
                            Portfolio
                        </NavLink>
                    ...
                    <button className="hidden rounded-full bg-blue-500 px-4 py-2 text-white transition hover:bg-blue-600 md:block">
                        Contact Us
                    </button>
                </nav>
